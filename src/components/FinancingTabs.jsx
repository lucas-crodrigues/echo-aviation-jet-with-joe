...
const FinancingTabs = () => {
  ...
  const stratusFinancial = (
    <>
      <section className="flex flex-col items-center bg-gradient-to-br from-white to-gray-200">
        <div className="max-w-7xl px-10 flex flex-col items-center py-10">
          ...
          <div className="tracking-wider w-full flex flex-col items-center">
            ...
            <a
              href="https://apply.stratus.finance/echoaviationassets2508456"
              target="_blank"
      ...
      <img src="/Echo-Aviation-Assets-LLC_New-FB-Template.jpg" alt="Stratus Financial Banner" className="hidden md:block w-screen h-auto"></img>
      <section className="flex flex-col items-center bg-gradient-to-br from-white to-gray-200">
        <div className="max-w-7xl px-10 flex flex-col items-center py-10">
          ...
          <div className="tracking-wider">
            ...
            <p>Stratus Financial pays the funds directly to Echo Aviation.</p>
          </div>
          <div className="pt-10 self-start">
            ...
            <ul className="list-disc pl-10">
              <li>
                <a
                  href="/files/(Digital)-Echo-Aviation-Assets-LLC_Trifold-Brochure-(11x8.5in).pdf"
                  target="_blank"
              ...
              <li>
                <a
                  href="/files/(Digital)-Echo-Aviation-Assets-LLC__Stratus-Advantage.pdf"
                  target="_blank"
                  className="hover:text-blue-800 hover:underline text-blue-600"
                >
              ...
              <li>
                <a
                  href="/files/(Digital)-Echo-Aviation-Assets-LLC_One-Page-Flyer.pdf"
                  target="_blank"
                  className="hover:text-blue-800 hover:underline text-blue-600"
                >
      ...
      <div className="max-w-7xl px-10 flex flex-col items-center py-10">
        ...
        <div className="tracking-wider">
          ...
          <p className="pt-5">
            ...
            heights. Start your journey with Echo Aviation and Flight Training
            Finance.
          </p>
