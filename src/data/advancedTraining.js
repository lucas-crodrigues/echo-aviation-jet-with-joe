const advancedTrainings = {
  data: {
    ...
    // SEO Header Stuff
    pageTitle: "ADVANCED FLIGHT TRAINING | Echo Aviation",
    pageDescription:
      "Enhance your aviation expertise with advanced flight training at Echo Aviation. Gain proficiency in complex, high-performance, multi-engine, spin training, and more.",
    ...
    header: {
      ...
      paragraph: `Refine your skills and elevate your proficiency with Echo Aviation’s advanced training. Designed for licensed pilots, these programs cover specialized areas like multi-engine operations, spin recovery, and high-performance aircraft, ensuring you're prepared for every challenge in the skies.`,
      buttons: [
        {
          name: "Enroll Today",
          link: "#contact",
    ...
    roadmap: {
      ...
      finalParagraph:
        "Whether you’re advancing your career or enhancing personal skills, Echo Aviation’s advanced training provide the knowledge, experience, and confidence to excel. Join us to take your flying expertise to the next level.",
      finalButton: {
        name: "Enroll Now",
        link: "/start-flying",
        primary: true,
