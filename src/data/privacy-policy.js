const privacyPolicies = {
  data: {
    heading: `Privacy Policy of<br /> Echo Aviation`,
    subheading: `Last updated: 07/03/2025`,
    content: [
      {
        heading: "Introduction",
        paragraphs: [
          "Echo Aviation operates the https://echoaviation.training/ website. This page is used to inform website visitors regarding our policies on the collection, use, and disclosure of Personal Information for users who interact with our website or services.",
      ...
      },
      {
        ...
        paragraphs: [
          "Our website may include links to other websites not operated by Echo Aviation. We advise you to review the privacy policies of these third-party sites. We are not responsible for the content or privacy practices of any external services.",
        ],
      },
      {
      ...
      },
      {
        heading: "Contact Us",
        paragraphs: [
          "If you have questions or concerns about this Privacy Policy, please contact us at info@echoaviation.training.",
        ],
      },
    ],
  },
