...
const fastTrackZeroToCFIData = {
  pageTitle: `Fast-Track Flight Training in Akron | ${COMPANY_NAME}`,

  // Top Header
  header: {
    stars: true,
    imagePath:
      "/src/assets/stock-echo-aviation-flight-training-independent-cfis-affordable-accelerated.jpg",
    headerH1: `Fast-Track Flight Training in Akron`,
    paragraph: `An all-inclusive, structured program in Akron designed to take you from zero experience to a Certified Flight Instructor (CFI). Build flight hours, gain real-world experience, and launch your professional aviation career.`,
    buttons: [
      {
        name: "Apply Now",
        link: "/start-flying",
  ...
  // Program Details
  details: {
    upperHeading: "Accelerate Your Aviation Career in Akron",
    heading: `Fast-Track Program Zero to Hero (PPL to CFI)`,
    subHeading:
      "For aspiring pilots in Akron who want an efficient and structured path to becoming a professional pilot, this all-inclusive program takes students from zero flight hours to Certified Flight Instructor (CFI).",

    title: "Overview",
    description: `
      Echo Aviation’s <strong>Fast-Track Program Zero to Hero (PPL to CFI)</strong> in Akron is designed for students looking to complete their training efficiently and advance toward a career in aviation.
      <br/><br/>
      ...
      ✈️ <strong>Training Location:</strong> Akron, Ohio with Echo Aviation’s independent CFIs.<br/>
      ...
      🛩 <strong>Aircraft Used:</strong> Locally sourced aircraft in the Akron area tailored to your training needs.<br/>
    ...
    keyPoints: [
      "Train in Akron from Zero to CFI in 12–18 Months",
    ...
    included: {
      ...
      items: [
        "265 flight training hours with experienced Akron-area CFIs",
    ...
    benefits: {
      ...
      items: [
        ...
        "Expert Instructors and One-on-One Mentorship in Akron",
    ...
    cta: {
      imagePath:
        "/src/assets/stock-echo-aviation-flight-training-independent-cfis-affordable-accelerated.jpg",
      title: "Launch Your Aviation Career in Akron with Echo Aviation",
      description:
        "Train locally with expert independent CFIs in Akron, gain hands-on experience, and complete your flight training in as little as 12–18 months. Start your journey toward a professional aviation career today!",
      button: {
        name: "Apply Now",
        link: "/start-flying",
      },
    ...
    faqs: [
      {
        question:
          "How long does it take to complete the Fast-Track Program in Akron?",
        answer:
          "Our accelerated program in Akron allows students to complete training in <strong>12–18 months</strong>. A self-paced option is also available for those needing more flexibility.",
      },
      {
      ...
      {
        question: "What kind of aircraft will I train on in Akron?",
        answer:
          "Students train in locally sourced aircraft around Akron, chosen based on availability and tailored to your training needs.",
      },
      {
